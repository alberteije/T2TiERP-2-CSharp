...
namespace SISClient.ViewModel
{
    public class FuncionarioViewModel : ViewModelBase
    {
        ...
        public ObservableCollection<FuncionarioDTO> ListaFuncionario { get; set; }
        private FuncionarioDTO _FuncionarioSelected;
        ...
        public FuncionarioViewModel()
        {
            try
            {
                ListaFuncionario = new ObservableCollection<FuncionarioDTO>();
                IndiceNavegacao = 0;
        ...
        #region Infra
        public FuncionarioDTO FuncionarioSelected
        {
            get { return _FuncionarioSelected; }
            set
            {
                _FuncionarioSelected = value;
        ...
        public void BotaoInserir()
        {
            try
            {
                FuncionarioSelected = new FuncionarioDTO();
                IsEditar = true;
            }
            catch (Exception ex)
            {
            ...
            try
            {
                if (FuncionarioSelected != null)
                {
                    if (MessageBox.Show("Tem Certeza Que Deseja Excluir o Registro?", "Pergunta do Sistema", MessageBoxButton.YesNo, MessageBoxImage.Question) == MessageBoxResult.Yes)
                    {
                        ...
                        AtualizarListaFuncionario(IndiceNavegacao);
                    }
                }
                else
                    MessageBox.Show("Selecione um elemento na lista.", "Alerta do sistema", MessageBoxButton.OK, MessageBoxImage.Information);
            ...
            get
            {
                if (BotaoExportarXlsCommand == null)
                {
                    ...
                    (
                        param =>
                        {
                            DataGridExportacao.ItemsSource = ListaFuncionario;
