    ...
    internal class Banco_Caixa : AbstractBanco, IBanco
    {
        ...
        public override void ValidaBoleto(Boleto boleto)
        {
            if (boleto.Carteira.Equals("SR"))
            {
                if (boleto.NossoNumero.Length != 14)
                {
                    throw new Exception("Nosso Número inválido, Para Caixa Econômica - Carteira SR o Nosso Número deve conter 14 caracteres.");
                }
            }
            else
            {
                ...
                {
                    throw new Exception(
                        "Nosso Número inválido, Para Caixa Econômica o Nosso Número deve conter 10 caracteres.");
                }
