...
namespace ComponentePonto
{
    public class ACJEF_Cabecalho
    {
        ...
        public string Campo07 { get; set; } // Data inicial dos registros no arquivo, no formato “ddmmaaaa”.
        public string Campo08 { get; set; } // Data final dos registros no arquivo, no formato “ddmmaaaa”.
        public string Campo09 { get; set; } // Data de geração do arquivo, no formato “ddmmaaaa”.
        public string Campo10 { get; set; } // Horário da geração do arquivo, no formato “hhmm”.

        public ACJEF_Cabecalho()
        {
        }
        ...
        public string gerarLinhaTexto()
        {
            ...
            retorno += Funcoes.LFill(Campo07 == null ? "" : Campo07, 8);
