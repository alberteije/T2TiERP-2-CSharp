...
namespace ComponentePonto
{
    public class AFD_Registro5
    {
        ...
        public string Campo07 { get; set; } // Horário ajustado, no formato “hhmm”.

        public AFD_Registro5()
        {
        }
        ...
        public string gerarLinhaTexto()
        {
            ...
            retorno += Funcoes.LFill(Campo06 == null ? "" : Campo06, 12);
            retorno += Funcoes.LFill(Campo07 == null ? "" : Campo07, 52);
