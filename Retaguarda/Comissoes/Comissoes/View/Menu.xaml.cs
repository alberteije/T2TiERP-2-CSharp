...
namespace Cadastros.View
{
    ...
    public partial class Menu : RibbonWindow
    {
        ...
        {
            ViewModel.NovaPagina(new ComissaoPerfilPrincipal(), "Perfil");
        }

        private void BotaoMetas_Click(object sender, RoutedEventArgs e)
        {
            ViewModel.NovaPagina(new ComissaoObjetivoPrincipal(), "Objetivos / Metas");
        }
